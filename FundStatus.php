    ...
    <div class="table-responsive">
        <table class="table" id="fundTable">
			...
			$baseURL = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http";
                        ...
                        $downloadURL = $baseURL . "/diaportal/api/downloadUC.php?id={$iit_name}";
                        echo "<td><a href='{$downloadURL}' class='btn btn-primary'>Download UC</a></td>";
                        //echo "<td><a href='http://localhost/api/downloadUC.php?id={$iit_name}' class='btn btn-primary'>Download UC</a></td>";
